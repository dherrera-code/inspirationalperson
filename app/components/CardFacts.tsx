...
const CardFacts = ({ title, desc, img, alt }: CardInfo) => {
    return (
        <div className=''>
            <div className="flex flex-col items-center border border-gray-700 shadow-md rounded-lg shadow-sm md:flex-row max-w-[20rem] md:max-w-xl hover:bg-gray-100 dark:bg-[#F3F4F6] dark:text-black text-black">
