...
const CardFacts = ({ title, desc, img, alt }: CardInfo) => {
    return (
        <div className='object-contain'>
            {/* <Card className="max-w-sm dark:bg-[#F3F4F6] text-black shadow-md " imgSrc={img} imgAlt={alt}
            horizontal>
                <h5 className="text-2xl font-bold tracking-tight">{title}</h5>
                <p className="font-normal">{desc}</p>
            </Card> */}
            {/* <Card className="max-w-sm  dark:bg-[#F3F4F6] text-black shadow-md" horizontal>
                <Image className='' width={272} height={242} src={img} alt={alt}></Image>
                <h5 className="text-2xl font-bold tracking-tight">{title}</h5>
                <p className="font-normal">{desc}</p>
            </Card> */}
